...
const headers = [
  ...
  //{ title: 'Tipo Cuenta', key: 'tipoCuenta', sortable: true },
  //{ title: 'Idioma', key: 'idiomaCotizacion', sortable: true },
  //{ title: 'Contacto', key: 'contacto', sortable: true },
  //{ title: 'Dir. Fiscal', key: 'dirFiscal', sortable: true },
  //{ title: 'Dir. Entrega', key: 'dirEntrega', sortable: true },
  //{ title: 'Términos Entrega', key: 'terminosEntrega', sortable: true },
...
const cargarCotizaciones = async () => {
  try {
    ...
    console.log('Cotizaciones cargadas:', cotizaciones.value);
  } catch (error) {
  ...
  try {
    ...
    if (cotizacionData.encabezado) {
      ...
      storeCotizador.form = {
        ...
        personaContacto: encabezado.personaContacto || '',
        direccionFiscal: encabezado.direccionFiscal || '',
        direccionEntrega: encabezado.direccionEntrega || '',
