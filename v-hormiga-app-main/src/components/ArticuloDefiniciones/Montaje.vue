  ...
  <v-card class="mb-4" id="montaje" aria-label="Montaje" flat>
    ...
    <v-card-text v-if="store.articuloActual.itemCode !== 'KBK'">
      ...
      <v-row>
        ...
        <v-col cols="12" md="4" class="d-flex align-center">
          <label class="text-body-1">Plataforma de elevación para trabajos en altura (Geny)</label>
        </v-col>
        <v-col cols="12" md="8">
        ...
        <v-col cols="12" md="8">
          <v-select v-model="store.montaje.lineaVida" :items="['SHOSA', 'Cliente']" density="compact"
            :rules="[v => !!v || 'Campo obligatorio']" />
        </v-col>
      </v-row>
