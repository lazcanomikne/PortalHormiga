                ...
                <v-card class="mb-4" flat>
                  <v-card-text>
                    <v-row>
                      ...
                      <!-- Velocidad de traslación (solo si hay 2-3 carros) -->
                      <template v-if="store.carro.cantidadCarros >= 2">
                        <v-col cols="12" md="4" class="d-flex align-center">
                      ...
                      <template v-if="!['ZKKE', 'ZHPE', 'ZVPE'].includes(store.articuloActual.itemCode)">
                        ...
                        <v-col cols="12" md="8">
                          <v-text-field v-model="carro.cantidadRuedasTraslacion" type="number" min="0"
                        ...
                        <v-col cols="12" md="8">
                          <v-text-field v-model="carro.diametroRuedas" type="number" min="0"
                        ...
                        <v-col cols="12" md="8">
                          <v-text-field v-model="carro.cantidadTipoRuedaMotrizA" type="number" min="0"
                            density="compact" />
                        </v-col>
                        <v-col cols="12" md="4" class="d-flex align-center">
                        ...
                        <v-col cols="12" md="8">
                          <v-text-field v-model="carro.cantidadTipoRuedaConducidaMA" type="number" min="0"
                            density="compact" />
                        </v-col>
                        <v-col cols="12" md="4" class="d-flex align-center">
                        ...
                        <v-col cols="12" md="8">
                          <v-text-field v-model="carro.cantidadTipoRuedaLocaNA" type="number" min="0"
                            density="compact" />
                        </v-col>
                        <v-col cols="12" md="4" class="d-flex align-center">
                      ...
                      <v-col cols="12" md="12">
                        <v-row>
                          ...
                          <v-col cols="12" :md="carro.control == 'Contactores / Dos velocidades' ? 2 : 5">
                            <v-text-field v-model="carro.motorPotencia1" type="number" step="0.01" min="0"
                          ...
                          <v-col v-if="carro.control == 'Contactores / Dos velocidades'" cols="12" md="1"
                            ...
                            <span class="text-center text-h3">{{ carro.control == 'Contactores / Dos velocidades' ? '/'
                              : '-' }}</span>
                          </v-col>
                          <v-col cols="12" md="2" v-if="carro.control == 'Contactores / Dos velocidades'">
                            <v-text-field v-model="carro.motorPotencia2" type="number" step="0.01" min="0"
                          ...
                          <v-col cols="12" md="3" class="d-flex"
                            ...
                            <div class="text-h4 font-weight-medium text-center mr-2">{{
                              carro.motorPotencia1 }}{{ carro.control == 'Contactores / Dos velocidades' ? '/' : '-'
                                ...
                                carro.motorPotencia2 }}</div> <span class="text-h4 font-weight-medium text-center">
                              Kw</span>
                          </v-col>
                          <v-col cols="12" md="3" class="d-flex" v-else>
                            <div class="text-h4 font-weight-medium text-center mr-2">{{
                              carro.motorPotencia1 }}</div> <span class="text-h4 font-weight-medium text-center">
                              Kw</span>
                          </v-col>
                        </v-row>
                      </v-col>
