  ...
  <v-card class="mb-4" id="puente" aria-label="Puente" flat>
          ...
          <v-row>
            ...
            <v-col cols="12" md="8">
              <v-select v-model="puente.dispositivoElevacion" :items="['Polipasto de Cadena', 'Polipasto de Cable']"
                @update:model-value="getCodigoConstruccion(puente.dispositivoElevacion)" density="compact" />
            </v-col>
            <v-col cols="12" md="4" class="d-flex align-center">
            ...
            <v-col cols="12" md="8">
              <v-text-field v-model="puente.pesoAccesoriosAdicionales" type="number" suffix="kg" density="compact" @focus="$event.target.select()" />
            </v-col>
            <v-col cols="12" md="12">
            ...
            <template v-if="puente.inlcuyeEstructura">
              ...
              <template v-if="puente.anclaQuimica">
                ...
                <v-col cols="12" md="8">
                  <v-text-field v-model="puente.anclaQuimicaEspesor" suffix="mm" density="compact" @focus="$event.target.select()" />
                </v-col>
                <v-col cols="12" md="4" class="d-flex align-center">
                  <label class="text-body-1">Resistencia</label>
                </v-col>
                <v-col cols="12" md="8">
                  <v-text-field v-model="puente.anclaQuimicaResistencia" suffix="kg/cm2" density="compact" @focus="$event.target.select()" />
                </v-col>
              </template>
            </template>
            <v-col cols="12" md="12">
    ...
    <v-card-text v-else>
      ...
      <v-row>
        ...
        <v-col cols="12" md="8">
          <v-text-field v-model.number="store.puente.ruedasMotrices.cantidadRuedas" type="number" min="0" @focus="$event.target.select()"
        ...
        <v-col cols="12" md="8">
          <v-text-field v-model.number="store.puente.ruedasMotrices.diametroRuedas" type="number" min="0" @focus="$event.target.select()"
      ...
      <v-row>
        ...
        <v-col cols="12" md="8">
          <v-text-field v-model.number="store.puente.ruedasLocas.cantidadRuedas" type="number" min="0" @focus="$event.target.select()"
            :rules="[v => v >= 0 || 'No se permite negativos']" suffix="pzas" density="compact" />
        </v-col>
        <v-col cols="12" md="4" class="d-flex align-center">
          <label class="text-body-1">Diámetro de ruedas (mm)</label>
        ...
        <v-col cols="12" md="8">
          <v-text-field v-model.number="store.puente.ruedasLocas.diametroRuedas" type="number" min="0" @focus="$event.target.select()"
            :rules="[v => v >= 0 || 'No se permite negativos']" suffix="mm" density="compact" />
        </v-col>
        <v-col cols="12" md="4" class="d-flex align-center">
          <label class="text-body-1">Material de ruedas</label>
      ...
      <v-row>
        ...
        <v-col cols="12" md="8">
          <v-text-field v-model.number="store.puente.cantidadMotorreductores" type="number" min="0" @focus="$event.target.select()"
        ...
        <v-col cols="12" md="12">
          <v-row>
            ...
            <v-col cols="12" :md="store.puente.controlPuente == 'Contactores / Dos velocidades' ? 2 : 5">
              <v-text-field v-model.number="store.puente.motorPotenciaKw1" label="Motor" type="number" min="0" @focus="$event.target.select()"
            ...
            <v-col cols="12" md="2" v-if="store.puente.controlPuente == 'Contactores / Dos velocidades'">
              <v-text-field v-model.number="store.puente.motorPotenciaKw2" label="potencia (Kw)" type="number" min="0" @focus="$event.target.select()"
                step="0.01" :rules="[v => v >= 0 || 'No se permite negativos']" suffix="Kw" density="compact" />
            </v-col>
        ...
        <template v-if="store.datosBasicos.tipoPintura === 'Otra'">
          <v-col cols="12" md="4" class="d-flex align-center">
            <label class="text-body-1">Especifique Tipo de pintura</label>
          </v-col>
          <v-col cols="12" md="8">
            <v-text-field v-model="store.datosBasicos.especifiqueTipoPintura" density="compact" />
          </v-col>
        </template>
      </v-row>
...
onMounted(() => {
  ...
  if (store.puente.velocidad2 === undefined) {
    store.puente.velocidad2 = 0;
  }
});
