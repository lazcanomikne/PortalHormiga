<template>
  <v-app-bar app flat>
    ...
    <!-- Logo persistente (Solo visible si sidebar está cerrado o es móvil) -->
    <transition name="fade">
      <div v-if="!sidebar.open" class="d-flex align-center ml-2 mr-4" style="height: 40px">
        <img :src="theme.current.value.dark ? '/assets/logohormigasmalldark.png' : '/assets/logohormigasmall.png'"
              alt="Hormiga Logo" style="height: 100%; width: auto;" />
      </div>
    </transition>
